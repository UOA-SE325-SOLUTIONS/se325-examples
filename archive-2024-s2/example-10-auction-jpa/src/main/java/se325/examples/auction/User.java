...
public class User {
    ...
    protected User() {
        ...
        this.addressSetters.put(AddressType.BILLING, address -> { this.billingAddress = address; });
        this.addressSetters.put(AddressType.SHIPPING, address -> { this.shippingAddress = address; });
        this.addressSetters.put(AddressType.HOME, address -> { this.homeAddress = address; });
    }
