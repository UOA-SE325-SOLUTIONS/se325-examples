...
import se325.example16.parolee.domain.Curfew;
import se325.example16.parolee.domain.Movement;
import se325.example16.parolee.domain.Parolee;
import se325.example16.parolee.domain.mappers.GeoPositionMapper;
import se325.example16.parolee.dto.ParoleViolationDTO;
import se325.example16.parolee.utils.GeoUtils;
...
public class ParoleViolationSubscriptionManager {

    private static ParoleViolationSubscriptionManager instance;

    public static ParoleViolationSubscriptionManager instance() {
        if (instance == null) {
            instance = new ParoleViolationSubscriptionManager();
        }
        return instance;
    }

    private ParoleViolationSubscriptionManager() {
    }
